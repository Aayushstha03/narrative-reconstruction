...
def enrich_narrative_with_source_articles(
    grouped_events_path, narrative_output_path
):
...
if __name__ == '__main__':
    ...
    print(
        f'Narrative output enriched with source articles and saved to {output_path}'
    )
